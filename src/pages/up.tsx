...
const UploadS3: NextPage = () => {
  ...
  function onChangeFile(event: InputHTMLAttributes<HTMLInputElement>) {
    // @ts-ignore
      ...
      // aqui que pega a imagem do imput  
      // chamar handlesendFile conforme a qtd de arquivos
    ...
    //let newFileName = file.name.replace(/\..+$/, ""); // separar a extensão do nome para gerar um nome unico
    // @ts-ignore

        // sera que tem como fazer upload de um array com as imagens?
        // ou será preciso um upload para cada imagens
